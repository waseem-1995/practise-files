...
export const patchBagData = (clickedId, isQtySame) => async (dispatch) => {
  ...
  return axios
    .patch(`https://myntra-dataapi.onrender.com/cart/${clickedId}`, {
      quantity: `${isQtySame}`,
    })
    .then((res) => {
...
export const deleteBagData = (idx) => async (dispatch) => {
  ...
  return axios
    .delete(`https://myntra-dataapi.onrender.com/cart/${idx}`)
    .then((res) => {
...
export const getBagData = (payload) => async(dispatch) => {
  ...
  return axios
    .get("https://myntra-dataapi.onrender.com/cart", payload)
    .then((res) => {
