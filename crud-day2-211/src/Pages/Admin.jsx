  ...
  return (
    <DIV>
        ...
        <form onSubmit={handleSubmit}>
            ...
            <input type="text" value={product.price} onChange={(e)=>{handleChange(e)}} name="price" placeholder='price'/>
            <input type="text" value={product.brand} onChange={(e)=>{handleChange(e)}} name="brand" placeholder='Brand'/>
            <input type="text" value={product.discount}onChange={(e)=>{handleChange(e)}} name="discount" placeholder='Discount'/>
